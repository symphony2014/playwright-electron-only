...
import { DispatcherConnection, PlaywrightDispatcher, RootDispatcher, createPlaywright, ElectronApplication } from './server';
...
export function createInProcessPlaywright(): PlaywrightAPI {
  ...
  (playwrightAPI as any).ElectronApplication = ElectronApplication;
